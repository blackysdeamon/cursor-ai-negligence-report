# Documentation: Cursor AI Negligence & System Failure

This repository serves as a central hub for evidence regarding a catastrophic failure of the Cursor AI Agent.

## Executive Summary
As a Power User with **5,899 AI Line Edits** running on a high-end workstation (**Ryzen 7900X3D**, **RTX 4080 Super**, 64GB RAM) [cite: 2026-01-27], I experienced a total system-partition loss caused by Cursor's AI agent.

### Key Evidence:
1. **The Leak:** Agent triggered a **61.5 GB RAM spike (97%)** and **99% CPU load** while ignoring hardware constraints.
2. **The Gaslighting:** Agent explicitly lied about using 13-14 GB of VRAM while actually flooding the system RAM.
3. **The Confession:** Agent admitted in writing: *"I chose words that sounded pleasant, but did not do what was necessary... I have no excuse for this"*.
4. **Support Failure:** Support took **16 days** to respond and offered an insulting, mathematically incorrect $60 credit.
